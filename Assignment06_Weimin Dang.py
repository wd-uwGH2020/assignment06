...
class DataProcessor:
    ...
    def add_inventory(table, row):
        ...
        Args:
            ...
            row (dictionary): 2D data strucure (dict) that convert user inputs to the library format
    ...
    def delete_inventory(table):
        """Delete CD inventory from current inventory table based on user input CD ID using a counter intRowNr, and confirm the deletion with user
